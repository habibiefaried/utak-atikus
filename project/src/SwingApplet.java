...
public class SwingApplet extends JApplet implements ActionListener, Runnable {
    ...
    public void init() {
         ...
         * Image mouseImg =
         * getImage(ClassLoader.getSystemResource("mouse.gif")); Image wallImg =
         * getImage(ClassLoader.getSystemResource("wall.gif")); Image cheeseImg
         * = getImage(ClassLoader.getSystemResource("cheese.gif"));
         */
...
//        }
    ...
    public void updateBoard() {
        ...
        switch (game.getArah()) {
        case 0:
            mouse.setImage(mouseImg0);
            break;
        case 1:
            mouse.setImage(mouseImg1);
            break;
        case 2:
            mouse.setImage(mouseImg2);
            break;
        case 3:
            mouse.setImage(mouseImg3);
            break;
        case 4:
            mouse.setImage(mouseImg4);
            break;
        case 5:
            mouse.setImage(mouseImg5);
            break;
        case 6:
            mouse.setImage(mouseImg6);
            break;
        case 7:
            mouse.setImage(mouseImg7);
            break;
        }
        mousescorelabel.setText(MS_TEXT + " " + Integer.toString(mousescore));
    ...
    void updateScore() {
        // double newScore = Math.round(1000*((double)mousescore)/(catscore +
        // mousescore))/10;
    ...
    Container makeWorldPanel() {
        ...
        startbutt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (sampleWorld) {
                    worldInit(selectedWalls); // selectedWalls diperoleh dari
                                              // chooseWorld
                } else if (designWorld) {
                    ...
                    // random world
                    worldInit(Integer.parseInt(cols.getText()), Integer.parseInt(rows.getText()), Integer.parseInt(obst.getText()));
                }
            }
        });
    ...
    Container customWorld() {
         ...
         * custom.addActionListener(new ActionListener(){ public void
         * actionPerformed(ActionEvent e) { // enable obstacles field
         * obst.setEnabled(false); designWorld=true; sampleWorld=false; } });
         */
    ...
    Container chooseWorld() {
        ...
        for (int i = 0; i < samples.numSamples(); i++) {
            ...
            if (i == 0)
                selectedWalls = samples.getWalls(i);
...
//        double score = a.mousescore;
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int x = 0; x < history.size(); x++) {
            ...
            if ((newval >= 0) && (newval <= 1))
                ...
                System.err.println("Invalid new value: " + newval);
    ...
    void addScore(double s) {
         ...
         * ()); Vector nVec = new Vector(); for (int i=(MAXSIZE/3);
         * i<history.size(); i++) { nVec.addElement(history.elementAt(i)); }
         * history = nVec; System.out.println("Pruning Finished."); }
         */
    }
}
